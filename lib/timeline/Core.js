...
class Core {
  ...
  _create(container) {
    ...
    // Use the container's document and window to support popup windows
    const doc = container.ownerDocument || (container as any).document || document;
    console.log("🚀 ~ Core ~ _create ~ doc:", doc)
    const win = doc.defaultView || (doc as any).parentWindow || window;
    this.doc = doc;
    this.win = win;
    this.dom.root = doc.createElement("div");
    this.dom.background = doc.createElement("div");
    this.dom.backgroundVertical = doc.createElement("div");
    this.dom.backgroundHorizontal = doc.createElement("div");
    this.dom.centerContainer = doc.createElement("div");
    this.dom.leftContainer = doc.createElement("div");
    this.dom.rightContainer = doc.createElement("div");
    this.dom.center = doc.createElement("div");
    this.dom.left = doc.createElement("div");
    this.dom.right = doc.createElement("div");
    this.dom.top = doc.createElement("div");
    this.dom.bottom = doc.createElement("div");
    this.dom.shadowTop = doc.createElement("div");
    this.dom.shadowBottom = doc.createElement("div");
    this.dom.shadowTopLeft = doc.createElement("div");
    this.dom.shadowBottomLeft = doc.createElement("div");
    this.dom.shadowTopRight = doc.createElement("div");
    this.dom.shadowBottomRight = doc.createElement("div");
    this.dom.rollingModeBtn = doc.createElement("div");
    this.dom.loadingScreen = doc.createElement("div");
    ...
    const wheelType =
      "onwheel" in doc.createElement("div")
        ...
        : (doc as any).onmousewheel !== undefined
